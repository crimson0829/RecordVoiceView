package com.crimson.baidu_asr_library.baiduasr.control;
...
import com.crimson.baidu_asr_library.baiduasr.recognization.IRecogListener;
import com.crimson.baidu_asr_library.baiduasr.recognization.RecogEventAdapter;
...
public class BaiduAsrRecognizerManager {
    ...
    private static final String TAG = "BaiduAsrRecognizerManager";
     ...
     */
    public BaiduAsrRecognizerManager(Context context, IRecogListener recogListener) {
    ...
    public void loadOfflineEngine(Map<String, Object> params) {
        ...
        Logger.error(TAG, "loadOfflineEngine params:" + json);
    ...
    public void start(Map<String, Object> params) {
        String json = new JSONObject(params).toString();
        Logger.error(TAG, "asr params(识别参数，反馈请带上此行日志):" + json);
